...
class BlockTemplate():
    def __init__(self, data, coinbase_output_address, testnet = False, coinbase_message = "",
        ...
        self.merkle_branches = [i.hex() for i in merkle_branches([self.coinbase_tx["txId"],] + self.txid_list)]
    ...
    def submit_job(self, extra_nonce_1, extra_nonce_2, nonce, time):
        ...
        merkle_root = "6a24aa21a9ede2f61c3f71d1defd3fa999dfa36953755c690689799962b48bebd836974e8cf9"
