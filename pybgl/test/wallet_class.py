...
class WalletClassTests(unittest.TestCase):
    ...
    def test_is_wallet_menmonic(self):
        ...
        self.assertEqual(w.get_account_public_xkey(), xpub84)
        self.assertEqual(w.get_account_private_xkey(), xpriv84)
        ...
        self.assertEqual(w2.get_account_public_xkey(), xpub84)
        self.assertEqual(w2.get_account_private_xkey(), None)
        ...
        self.assertEqual(w3.get_account_public_xkey(), xpub84)
        self.assertEqual(w3.get_account_private_xkey(), xpriv84)
